...
if __name__ == '__main__':
    para = 64
    pub_key, pri_key = sm2_key_gen(para)
    c = Encrypt(b'asdasdasd', pub_key, para)
    print(c)
    print(Decrypt(c, pri_key, para))
