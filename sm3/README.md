...
- `./sm3_base`: Trival Implementation
  - LOOK-UP TABLE
- `./sm3_unroll`: Optimized implementation
  - UNROOL
  - LOOK-UP TABLE
- `./sm3_simd`: Optimized implementation
  - LOOK-UP TABLE
  - UNROOL
  - SIMD
...
> The test file is to big to upload so the premary test file is not provided in CMake, but you can hash any file and get the test because `sm3_test_simd` can regard a arg as filename to hash like: 
